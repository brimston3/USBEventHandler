﻿========================================================================
    DYNAMIC LINK LIBRARY: USBEventHandler-Projektübersicht
========================================================================

Diese USBEventHandler-DLL wurde vom Anwendungs-Assistenten für Sie 
erstellt.

Die Datei enthält eine Zusammenfassung des Inhalts der Dateien,
aus denen die USBEventHandler-Anwendung besteht.


USBEventHandler.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    mit dem Namen USBEventHandler.pch sowie eine vorkompilierte 
